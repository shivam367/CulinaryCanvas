...
export const MOCK_MENU_ITEMS: { [category: string]: MenuItem[] } = {
  Starters: [
    { id: "s1", name: "Bruschetta al Pomodoro", description: "Grilled bread rubbed with garlic and topped with fresh tomatoes, basil, and olive oil.", price: 12.99, imageUrl: "https://placehold.co/400x300.png", imageAiHint: "bruschetta food", type: "veg" },
    { id: "s2", name: "Crispy Calamari", description: "Lightly battered and fried calamari served with a zesty marinara sauce.", price: 15.99, imageUrl: "https://placehold.co/400x300.png", imageAiHint: "calamari food", type: "non-veg" },
  ],
  Mains: [
    { id: "m1", name: "Filet Mignon", description: "8oz prime cut filet, grilled to perfection, served with potato gratin and asparagus.", price: 38.99, imageUrl: "https://placehold.co/400x300.png", imageAiHint: "filet mignon", type: "non-veg" },
    { id: "m2", name: "Pasta Primavera", description: "Fresh pasta tossed with seasonal vegetables in a light cream sauce.", price: 22.99, imageUrl: "https://placehold.co/400x300.png", imageAiHint: "pasta primavera", type: "veg" },
    { id: "m3", name: "Grilled Salmon", description: "Atlantic salmon fillet with a lemon-dill sauce, served with roasted vegetables.", price: 29.99, imageUrl: "https://placehold.co/400x300.png", imageAiHint: "grilled salmon", type: "non-veg" },
  ],
  Desserts: [
    { id: "d1", name: "Tiramisu", description: "Classic Italian dessert made with mascarpone, coffee-soaked ladyfingers, and cocoa.", price: 10.99, imageUrl: "https://placehold.co/400x300.png", imageAiHint: "tiramisu dessert", type: "veg" },
    { id: "d2", name: "Chocolate Lava Cake", description: "Warm chocolate cake with a molten center, served with vanilla bean ice cream.", price: 11.99, imageUrl: "https://placehold.co/400x300.png", imageAiHint: "lava cake", type: "veg" },
  ],
  Beverages: [
...
export const MOCK_BLOG_POSTS: BlogPost[] = [
  {
    ...
    imageAiHint: "seasonal ingredients",
